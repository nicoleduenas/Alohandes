...
class SQLCliente 
{
	 ...
	 * @param idBebedor - El identificador del Cliente
	 * @param nombre - El nombre del bebedor
	 * @param ciudad - La ciudad del bebedor
	 * @param presupuesto - El presupuesto del bebedor (ALTO, MEDIO, BAJO)
	 * @return EL número de tuplas insertadas
	 */
	public long adicionarCliente (PersistenceManager pm, long idCliente, String nombre, String ciudad, String presupuesto) 
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaCliente () + "(id, nombre, ciudad, presupuesto) values (?, ?, ?, ?)");
        q.setParameters(idCliente, nombre, ciudad, presupuesto);
